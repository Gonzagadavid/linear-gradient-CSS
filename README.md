# Linear Gradient CSS  :paintbrush: 
...
7. agora é só colar em seu CSS, **obsevando que o linear-gradient não funciona em background-color**(é importante colocar no background como na imagem abaixo)
